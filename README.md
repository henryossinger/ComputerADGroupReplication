...
Simple script that replicates AD groups from one computer object onto another. 
...
```powershell
$oldcomputer = Read-Host -prompt "Please enter the old computer name"
$newcomputer = Read-Host -prompt "Please enter the new computer name"

# This is required because powershell only recognizes them as computer objects if "$" is addded at the end of the name 
